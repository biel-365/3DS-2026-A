      ...
      <div className="row g-4">
              ...
              {carrinho.length === 0 ? (
                ...
                <>
                  {carrinho.map((item, index) => (
                    <div key={item.id} className="row mb-4 position-relative align-items-center">
                      ...
                      <div className="col-12 col-md-4 mt-3 mt-md-0">
                        <div className="row align-items-center text-center text-md-start">
                          <div className="col-12 col-md-5 mb-3 mb-md-0">
                            <div className="border border-dark-subtle border-1 d-flex justify-content-center align-items-center rounded-4 gap-2 py-1">
                              <button
        ...
        <div className="col-12 col-lg-4">
          ...
          >
            ...
            <div className="card-body p-3 p-md-4 pt-3">
