...
const PromoCard = (props) => {
  ...
  return (
    <div id="PromoCard" className="promoCard card border-0 overflow-hidden h-100">
      <img
      ...
      <div className="card-body d-flex flex-column gap-2 p-3">
        ...
        <div className="m-0 row h-100 align-items-center justify-content-center">
          <span className="desconto col-4 h-100 fw-bold h6 h-md-5 m-0 d-flex align-items-center justify-content-center">
            -{props.desconto}%
          </span>
